-- ============================================
-- STEP 0: Update Interaction Timeline Function (Optional)
-- ============================================
-- This updates the get_interaction_timeline function to include meetings via meeting_attendees
-- You can run this before or after steps 1 and 2, or skip it if you only need the RLS fix
-- ============================================
...
BEGIN
  ...
  SELECT 
    ...
    t.last_message_date as interaction_timestamp,
