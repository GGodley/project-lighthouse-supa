-- Fix the get_customer_profile_details function with correct column names
-- This function should work with the actual remote database schema
        ...
        'allInteractions', (
          ...
          FROM (
            ...
            SELECT
              ...
              m.start_date AS interaction_date,  -- Changed from meeting_date to start_date
              m.summary,
