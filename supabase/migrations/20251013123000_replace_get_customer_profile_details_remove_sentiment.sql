-- Replace get_customer_profile_details to remove all sentiment references
-- and align strictly with columns known to exist remotely.
...
BEGIN
  RETURN (
    SELECT json_build_object(
      ...
      -- Last 10 emails (only existing columns)
      'emails', (
      ...
      -- Last 5 meetings (only existing columns)
      'meetings', (
        SELECT COALESCE(json_agg(
          json_build_object(
...
-- Ensure the function runs with the correct search_path and is callable
