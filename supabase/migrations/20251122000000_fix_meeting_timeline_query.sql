-- Fix meeting timeline query to only include meetings with summaries and start_time
-- This ensures meetings with summaries appear in the interaction timeline
