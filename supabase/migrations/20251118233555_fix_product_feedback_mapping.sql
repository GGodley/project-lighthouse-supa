-- Fix get_company_page_details function to properly map feature_requests fields
-- This ensures the UI receives properly formatted data with all necessary fields
